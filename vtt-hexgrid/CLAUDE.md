...
- **Aclaración: la "zona de alerta" del escenario 2 no es la que se ve con 👓** (2026-09-22, P105 abierta): `percepcionEvaluarRuta` (quien camina detecta a un oculto) chequea la **zona propia del que camina en cada paso de su ruta**, orientada hacia donde se está moviendo en ESE paso — no la zona real (fija, según su rotación) del token oculto que dibuja 👓 Ver conos. Es a propósito (importa la atención de quien camina, no hacia dónde mira el oculto), pero es fácil de confundir con la zona que se ve dibujada — no hay manera de previsualizar la zona real que se va a usar, porque depende del camino que se arrastre. Ver P105 en `docs/preguntas-abiertas.md`: si conviene simplificarlo para que coincida con lo que se ve dibujado.
