...
- [ ] **Llevar el crítico nuevo a la ficha y al mapa**: PdG − Evasión ≥ rango del arma (nivel N, N − Resistencia d20, el mejor; doble/triple/cuádruple daño; ignora armadura; multiplica todo el daño del golpe). Reemplaza al stat Crit. Cambio grande: hacerlo en pasos chicos.
