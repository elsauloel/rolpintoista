...
- 🔲 **P94. Pool de armas naturales (idea pendiente, 2026-09-20).** Diseñar un **pool de armas naturales con distintas variantes** (garras, colmillos, tentáculos, puños…) para cargarlas en un creep de manera automática sin configurar sus stats paso a paso. Se conecta con P92 (asistente de creeps) y P93 (trofeos). Sin fecha.
