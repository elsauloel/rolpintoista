...
**Falta de la etapa 1:** empate (gana el defensor, a confirmar: P-Empate). **Sin probar en mesa** (solo con un Firestore simulado): pegar las reglas y probar con dos personas.
