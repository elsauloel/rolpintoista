...
- 🔶 **P118. Efecto de cadena del rayo (idea del dueño, 2026-09-25, como elemento de diseño).** Otra característica del **daño de rayo** (además de la Parálisis): puede generar un **efecto de cadena**, es decir, **saltar de un personaje a otro bajo ciertas circunstancias**. Falta definir esas circunstancias (¿objetivos cercanos? ¿a los metálicos o mojados? ¿por tirada?), a cuántos saltos, si el daño baja en cada salto, si alcanza a aliados (fuego amigo del efecto, ver el criterio de trampas: lo mágico distingue aliados de rivales) y cuánto vale en calidad y precio (P112). Para armas y skills de rayo (P116).
