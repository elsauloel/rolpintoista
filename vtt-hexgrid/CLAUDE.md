...
- **Orden de turnos: los caídos se saltean** (2026-09-25, de "A desarrollar": "cuando un pj está muerto, anular tabla de turnos"): un **personaje** con HP 0 (o `resumen.muerto`) queda fuera del orden mientras lo esté: **▶ Siguiente** lo saltea (`iniciativaFueraDeJuego`; si cayeron todos, avanza normal) y la lista lo muestra apagado, tachado y con 💀. Si lo curan vuelve solo. Los creeps derrotados siguen siendo cosa del GM (los saca de la lista).
