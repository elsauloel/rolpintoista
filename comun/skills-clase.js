...
const CLASES_SKILLS = [
  {id: 'warrior', nombre: 'Warrior', habilidades: [
    ...
    {id: 'warrior-golpe-brutal', nombre: 'Golpe brutal', costo: '3', nitrosCosto: 'ATAQUE', tiradaStat: 'pdg',
  ...
  {id: 'tanque', nombre: 'Tanque', habilidades: [
    ...
    {id: 'tanque-shockwave', nombre: 'Shockwave', costo: '4', nitrosCosto: 0, tiradaStat: 'fue',
     detalle: 'Flash (SP x 2: en turno ajeno cuesta 8 SP, a mano). Onda expansiva: al ejecutar tirás Fuerza. Cada enemigo adyacente tira Constitución (a mano): el que pierde queda en Pajaritos (PdG y Evasión a la mitad) durante 2 turnos (a mano).'},
    {id: 'tanque-aura-de-espinas', nombre: 'Aura de espinas', costo: '1', nitrosCosto: 1,
     efectoNombre: 'Espinas', efectoTurnos: 1,
     efectoDetalle: '✋ A mano: mientras dure, cada ataque cuerpo a cuerpo que recibe le devuelve al atacante 1/4 (25 %) del daño CRUDO del golpe (antes de Defensa y escudos), redondeado hacia arriba, como daño directo (ignora Defensa). El GM o la mesa lo aplican; el estado solo recuerda que está activo y cuántos turnos dura.',
     detalle: 'Hasta el comienzo de tu próximo turno, cada ataque cuerpo a cuerpo que recibís le devuelve al atacante 1/4 del daño crudo del golpe (antes de Defensa), redondeado hacia arriba, como daño directo (a mano).'},
    ...
    {id: 'tanque-takle', nombre: 'Takle', costo: '3', nitrosCosto: 0, tiradaStat: 'pdg', tiradaBono: 1,
     detalle: 'Flash (SP x 2). Te desplazás hasta 2 casillas (gastan No2) y atacás con PdG +1; te pueden esquivar, no parrear. Si conecta y ganás Constitución vs Constitución (a mano): pierde 2 No2 y lo empujás 2 casillas; en su turno, además pasa al final de la iniciativa (si era el último, lo pierde).'},
  ...
  {id: 'mago', nombre: 'Mago', habilidades: [
    ...
    skillSA('mago', 'Chispazo', 'SP 1. No2 1. Hechizo (PG: Esp). Dispara un proyectil T6 P1 (1d6) que ignora armadura. ⚖ Rebalanceado 2026-09-25 (antes No2 3 y T4): equiparado a la Varita de proyectil mágica de buena calidad (1d6 por 1 Nitro); a auditar con el grupo.'),
