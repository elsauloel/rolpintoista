...
**Todavía no:** **deshacer** el daño aplicado (por ahora se corrige con el HP directo del mapa o con Ctrl+Z), la **durabilidad** (el arma o escudo que bloqueó y la armadura rota por ítem) y los **efectos del golpe** (etapa 5, con los momentos de dado y «Aplicar»).
