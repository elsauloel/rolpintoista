...
- **Tipos de daño mágico:** **arcano** (el más puro: directo a la vida, sin efectos adicionales) y elementales **fuego, hielo y rayo** por ahora; también dan espacio de diseño para ítems defensivos. Sugerencia (a aprobar): fuego → Prende fuego, hielo → Escarcha, rayo → Stun; candidatos futuros: ácido, veneno, sagrado, sombra.
