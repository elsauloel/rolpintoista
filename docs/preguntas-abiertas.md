...
- ✅ **P5. Tirada de detección: cuántas.** ⚠ Reemplazada 2026-09-19: mientras un personaje se mueve, la zona de alerta (detección con tirada) NO cuenta ni interrumpe — esa detección pide estar quieto y atento; solo el cono (detección inmediata) corta el movimiento. Antes decía: **una por cada paso que da dentro de la zona de alerta** (cada casillero de la ruta que cae en la alerta cuenta como una tirada). Como la tirada es manual, el mapa solo cuenta y avisa cuántas hay que hacer.
