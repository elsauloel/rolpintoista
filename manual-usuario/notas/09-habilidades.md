...
## En revisión
Daño en área, Takle, Taunt y Miti-Miti (comparte la mitad del daño con un protegido).

## Estados de la clase
- [[Pajaritos]]: PdG y Evasión a la mitad.
- **Sentado**: la Evasión se parte a la mitad (al resultado de la tirada, para abajo), no podés atacar ni hacer dodge roll y no vence solo: **levantarte cuesta 1 No2** (botón Levantarse de la Botonera). Ver [[Sentado]].
