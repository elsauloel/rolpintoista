...
- ✅ **P118. Efecto de cadena del rayo (dicho por el dueño, 2026-09-25; regla cerrada).** El **daño de rayo** puede **saltar de un personaje a otro**: **hasta 3 casillas de distancia** del último golpeado, **una sola vez por objetivo**, y **cada salto hace la mitad del daño del anterior, redondeado hacia arriba**. Implementado como **⚡ Rayo en cadena** en "Recibe daño" del token (mapa): el daño va **directo a la vida** (magia, sin Defensa) y salta al **más cercano** de los del **mismo bando** que el primer golpeado (los rivales de quien lanza el rayo), hasta que no quede nadie a ≤ 3 casillas; aplica solo lo que ese cliente puede (creeps si es el GM, sus propios personajes) y avisa en la Mesa el resto para aplicarlo a mano. Pendiente: que una skill o arma de rayo lo dispare sola; si alcanza a aliados; su peso en calidad y precio (P112).
...
- ⬜ **P-Duelo-defensa. Etapa 2 del duelo: Evasión / Parry / Bloqueo desde el defensor — 2026-09-26.** Propuesta y 5 preguntas (elegir a ciegas, Parry ganado + Bloqueo perdido, crítico con Parry, cuándo se ofrece el contraataque, tiempo límite) en `ataque-paso-a-paso.md`, sección «Etapa 2».

- ⬜ **P-Durabilidad. Durabilidad de armas, escudos y armaduras — 2026-09-26.** Decidido por el dueño: armas y escudos 2 por punto de Peso; si se pierde el Bloqueo pasa la mitad del daño y se gasta 1 punto del objeto que bloqueó; las armaduras también llevan durabilidad. Faltan 8 preguntas (fórmula de la armadura, qué pasa al llegar a 0, reparación, redondeo, creeps…) en [`durabilidad.md`](durabilidad.md).
