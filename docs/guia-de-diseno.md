...
- **Tipos de daño mágico:** **arcano** (el más puro: directo a la vida, sin efectos adicionales) y elementales **fuego, hielo y rayo** por ahora; también dan espacio de diseño para ítems defensivos. Efectos: **hielo → Escarcha** (−1 No2 máx.), **rayo → Parálisis** (debuff nuevo: PdG, Parry y Evasión a la mitad; mezcla de Lisiado y Pajaritos), **fuego → a definir** (no puede ser daño por turnos: eso ya es Veneno y Sangrado). Candidatos futuros: ácido, veneno, sagrado, sombra.
